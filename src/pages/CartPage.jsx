...
function CartPage() {
  const { cartItems, removeFromCart, updateQuantity, subtotal, clearCart, isLoggedIn, discount, discountedTotal } =
    useCart()
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between font-bold">
                <span>Total</span>
                <span>${isLoggedIn ? discountedTotal.toFixed(2) : subtotal.toFixed(2)}</span>
              </div>

              {!isLoggedIn && (
                <div className="bg-primary/5 p-3 rounded-md mt-4">
                  <p className="text-sm font-medium">Members save 10% on every order</p>
