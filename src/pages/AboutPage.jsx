  ...
  return (
    <div className="container px-4 py-12 mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        <div>
          <img src="/placeholder.svg?height=600&width=600" alt="StyleHub store" className="rounded-lg w-full h-auto" />
        </div>
        <div className="space-y-6">
          <h2 className="text-2xl font-bold">Our Story</h2>
          <p className="text-muted-foreground">
            Founded in 2015, StyleHub began with a simple mission: to create high-quality, timeless clothing that
            empowers people to express themselves through fashion. What started as a small boutique in New York has
            grown into a global brand with a presence in major cities around the world.
          </p>
          <p className="text-muted-foreground">
            Our founder, Jane Smith, believed that fashion should be accessible, sustainable, and inclusive. These core
            values continue to guide everything we do, from design to production to customer service.
          </p>
          <p className="text-muted-foreground">
            Today, StyleHub is known for its commitment to quality craftsmanship, ethical production practices, and
      ...
      <div className="bg-primary/5 p-8 rounded-lg text-center">
        ...
        <p className="text-muted-foreground max-w-[600px] mx-auto mb-6">
          ...
          to learn more about career opportunities at StyleHub.
        </p>
